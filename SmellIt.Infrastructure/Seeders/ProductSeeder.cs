            ...
            if (!_dbContext.Products.Any())
            {
                List<Product> products = new List<Product>
                {
                    ...
                    new Product
                    {
                        ...
                        FragranceGroupId = _dbContext.FragranceGroups.Where(c=>c.NameKey.Equals("Oriental")).Single().Id,
                    ...
                    new Product { 
                        ...
                        FragranceGroupId = _dbContext.FragranceGroups.Where(c=>c.NameKey.Equals("Aromatic")).Single().Id,
                    ...
                    new Product
                    {
                        ...
                        FragranceGroupId = _dbContext.FragranceGroups.Where(c=>c.NameKey.Equals("Fruity")).Single().Id,
                        GenderId = _dbContext.Genders.Where(c=>c.NameKey.Equals("Women")).Single().Id,
                        CreatedById = _dbContext.Users.FirstOrDefault() !.Id
                    },
                    new Product
                    {
                        ...
                        FragranceGroupId = _dbContext.FragranceGroups.Where(c=>c.NameKey.Equals("Spicy")).Single().Id,
                        GenderId = _dbContext.Genders.Where(c=>c.NameKey.Equals("Men")).Single().Id,
                        CreatedById = _dbContext.Users.FirstOrDefault() !.Id
                    },
                    new Product
                ...
                {
                    new TranslationEngb{Key="SmellItDiffuser", Value = "Smell It Diffuser"},
                    new TranslationEngb{Key="GoodGirl", Value = "Good Girl"},
                    new TranslationEngb{Key="Sauvage", Value = "Sauvage"},
                    new TranslationEngb{Key="Si", Value = "Si"},
                    new TranslationEngb{Key="1Million", Value = "1 Million"},
                    new TranslationEngb{Key="Eros", Value = "Eros"},
                    new TranslationEngb{Key="BlackOpium", Value = "Black Opium"},
                ...
                {
                    new TranslationPlpl{Key="SmellItDiffuser", Value = "Dyfuzor Smell It"},
                    new TranslationPlpl{Key="GoodGirl", Value = "Good Girl"},
                    new TranslationPlpl{Key="Sauvage", Value = "Sauvage"},
                    new TranslationPlpl{Key="Si", Value = "Si"},
                    new TranslationPlpl{Key="1Million", Value = "1 Million"},
                    new TranslationPlpl{Key="Eros", Value = "Eros"},
                    new TranslationPlpl{Key="BlackOpium", Value = "Black Opium"},
