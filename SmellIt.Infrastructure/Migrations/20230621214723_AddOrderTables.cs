        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderStatus_AspNetUsers_DeletedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatusTranslations_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderStatusTranslations_AspNetUsers_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_OrderStatusTranslations_AspNetUsers_ModifiedById",
                        column: x => x.ModifiedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderStatusTranslations_OrderStatus_OrderStatusId",
                        column: x => x.OrderStatusId,
                        principalTable: "OrderStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatus_DeletedById",
                table: "OrderStatus",
                column: "DeletedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusTranslations_CreatedById",
                table: "OrderStatusTranslations",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusTranslations_DeletedById",
                table: "OrderStatusTranslations",
                column: "DeletedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusTranslations_ModifiedById",
                table: "OrderStatusTranslations",
                column: "ModifiedById");
