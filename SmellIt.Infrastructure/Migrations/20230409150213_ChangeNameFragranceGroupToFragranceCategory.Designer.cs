...
namespace SmellIt.Infrastructure.Migrations
{
    ...
    [Migration("20230409150213_ChangeNameFragranceGroupToFragranceCategory")]
    partial class ChangeNameFragranceGroupToFragranceCategory
    {
            ...
            modelBuilder.Entity("SmellIt.Domain.Entities.Product", b =>
                {
                    ...
                    b.HasOne("SmellIt.Domain.Entities.FragranceCategory", "FragranceGroup")
                        .WithMany("Products")
