    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LayoutTexts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "LayoutTextTranslations",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Text = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                    LayoutTextId = table.Column<int>(type: "int", nullable: false),
                    LanguageId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LayoutTextTranslations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LayoutTextTranslations_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LayoutTextTranslations_LayoutTexts_LayoutTextId",
                        column: x => x.LayoutTextId,
                        principalTable: "LayoutTexts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LayoutTextTranslations_LanguageId",
                table: "LayoutTextTranslations",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_LayoutTextTranslations_LayoutTextId",
                table: "LayoutTextTranslations",
                column: "LayoutTextId");
