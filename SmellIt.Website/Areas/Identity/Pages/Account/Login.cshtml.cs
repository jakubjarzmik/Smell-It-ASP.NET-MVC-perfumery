...
public class LoginModel : PageModel
{
    ...
    public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, IMediator mediator)
    {
    ...
    public async Task<IActionResult> OnPostAsync(string returnUrl = null)
    {
        ...
        if (ModelState.IsValid)
        {
            ...
            if (result.Succeeded)
            {
                await _mediator.Send(new AddCartItemsToUserCommand(Session.GetSession(HttpContext),Input.Email));
